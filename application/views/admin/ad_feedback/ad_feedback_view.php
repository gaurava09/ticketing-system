...
<div class="float-right">
  <a class="btn btn-primary" type="button" href="<?php echo site_url('feedback/pdf/'.$complaint['id']); ?>">Download PDF</a>
  <a class="btn btn-primary" type="button" data-dismiss="modal" href="<?php echo site_url('feedback'); ?>"><i class="i-Left-3"></i> Back</a>
</div>
...
<input class="form-control"  type="text" placeholder="Company Name" value="<?php echo cap(ps($customer,'company_name')); ?>" readonly="" />
</div>

<div class="col-md-3 form-group mb-3">
<label for=" ">Customer Name</label>
<input class="form-control"  type="text" placeholder="Customer Name" value="<?php echo ucfirst(ps($customer,'first_name')).' '.ucfirst(ps($customer,'last_name')); ?>" readonly="" />
</div>
...
<input class="form-control" id="period" type="text" placeholder="From To" value="<?php echo $visit_date; ?>" name="period"  readonly="" />
</div>
<?php } ?>
...
<div class="col-2">
<div class="form-check"><input class="form-check-input" id="gridRadios2" type="radio" name="suitable_time" value="no" <?php if($feedback['suitable_time'] == 'no'){ echo 'checked';} ?> disabled>
